        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              Solusi terpercaya untuk kebutuhan serabutan Anda. Temukan tukang profesional untuk berbagai layanan perbaikan dan pemeliharaan.
            </p>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.layanan.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-sm leading-6 text-gray-300 hover:text-primary transition-colors duration-300"
                      >
                        {item.name}
                      </Link>
                    </li>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  ...
                  <li>
                    <a href="tel:+6281234567890" className="text-sm leading-6 text-gray-300 hover:text-primary transition-colors duration-300">
                      +62 812-3456-7890
                    </a>
                  </li>
                  <li>
                    <a href="mailto:info@serabutaja.com" className="text-sm leading-6 text-gray-300 hover:text-primary transition-colors duration-300">
                      info@serabutaja.com
                    </a>
                  </li>
                </ul>
